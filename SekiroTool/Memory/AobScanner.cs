...
public class AoBScanner(IMemoryService memoryService)
{
    ...
    public void DoMainScan()
    {
        ...
        Parallel.Invoke(
            ...
            () => Offsets.Functions.MatrixVectorToProduct =
                FindAddressByPattern(Patterns.MatrixVectorToProduct).ToInt64(),
            ...
            () => Offsets.Functions.FindChrInsChrEntityId =
                FindAddressByPattern(Patterns.FindChrInsChrEntityId).ToInt64(),
            () => Offsets.Functions.ForceAnimationByChrEventModule =
                FindAddressByPattern(Patterns.ForceAnimationByChrEventModule).ToInt64(),
            () => Offsets.Functions.FormatCutscenePathString =
                FindAddressByPattern(Patterns.FormatCutscenePathString).ToInt64(),
        ...
        Console.WriteLine(
            $"Functions.ForceAnimationByChrEventModule: 0x{Offsets.Functions.ForceAnimationByChrEventModule:X}");
